            ...
            <div className={paddingBottom ? "mil-inner-banner mil-p-0-120" : "mil-inner-banner"}>
                <div
                    ...
                    <div className="mil-animation-frame">
                        <div className="mil-animation mil-position-4 mil-dark mil-scale" data-value-1="6"
                             data-value-2="1.4"><Pentagon/></div>
                    </div>
                    <div className="container">
                        ...
                        {headingSize == 1 &&
                            <h1 className="" dangerouslySetInnerHTML={{__html: pageTitle}}/>
                        }
                        {headingSize == 2 &&
                            <h2 className={anchorLink != 0 ? "mil-mb-30" : ""}
