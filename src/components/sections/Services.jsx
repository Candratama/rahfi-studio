            ...
            <div className="mi-invert-fix">
                ...
                <div className="container mil-p-120-0">
                    ...
                    <div className="row mil-services-grid m-0">
                        ...
                        <div key={`services-item-${key}`} className="col-md-6 col-lg-6 mil-services-grid-item p-0">

                            <Link href={item.link} className="mil-service-card-sm mil-up">
                                <h3 className="mil-muted mil-mb-30" dangerouslySetInnerHTML={{__html : item.title}} />
